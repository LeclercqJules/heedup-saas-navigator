...
- `src/routes/index.tsx:435` et `src/routes/index.tsx:1425` : autres boutons « Accéder au lancement » hors navigation.
...
1. Remplacer les deux CTA de navigation par « Créer mon espace » et les faire pointer vers `/connexion` sur bureau et mobile.
